...
export function logReject(path: string, error?: string | HuginnErrorData, status?: number) {
   ...
   consola.info(`${endText} ${divider} ${rejectText} ${divider} ${pathText} ${divider}${statusText}${errorText}\n`);
}
