...
const AppMainHomeChannelsAtmeIndexRoute =
  AppMainHomeChannelsAtmeIndexRouteImport.update({
    id: '/channels/@me/',
    path: '/channels/@me/',
    getParentRoute: () => AppMainHomeRoute,
  } as any)
const AppMainHomeChannelsAtmeChannelIdRoute =
  AppMainHomeChannelsAtmeChannelIdRouteImport.update({
...
const AppMainHomeRouteWithChildren = AppMainHomeRoute._addFileChildren(
  AppMainHomeRouteChildren,
)
