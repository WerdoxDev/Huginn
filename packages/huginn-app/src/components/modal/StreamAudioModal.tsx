	...
	return (
		...
		>
			<div className="flex flex-col gap-y-3 pb-5">
				<div className="text-center font-bold text-2xl text-text">Stream Audio</div>
				<div className="px-2 text-center text-text/80">Choose an application to share it's audio with others</div>
				<div className="scroll-alternative mx-5 mt-5 flex h-72 flex-col gap-y-2 overflow-y-scroll rounded-lg border border-primary-700 p-2.5 pr-1.5">
					{isLoading ? (
						...
						data?.map((x) => (
							<button
								className={clsx(
									"flex cursor-pointer items-start gap-x-2 rounded-md bg-surface-alt px-2 py-2 text-left ring-primary-700 transition-shadow",
