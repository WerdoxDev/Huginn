...
import { clearTemporaryDevice, refreshDevices, useDevice } from "@stores/deviceStore";
...
// const NO_DEVICE_OPTION: SelectItem = { text: "No device", value: "" };

export default function SettingsAudioVideoTab(props: SettingsTabProps) {
            ...
            <div className="flex w-full max-w-xl flex-col gap-y-5">
               ...
               {cameraPermission?.status === "granted" ? (
                  <>
                     <HuginnSelect
                        className="w-full"
                        disabled={cameraDeviceOptions.length === 0}
            ...
            <div className="flex w-full flex-col gap-y-5">
               <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <HuginnSelect
                     ...
                     disabled={inputDeviceOptions.length === 0}
                  ...
                  <HuginnSelect
                     ...
                     disabled={outputDeviceOptions.length === 0}
