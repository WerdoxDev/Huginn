...
export default function ColorThemeSelector(props: Pick<SettingsTabProps, "onChange">) {
   ...
   return (
      <div className="flex w-full flex-col">
         ...
         <div className="flex flex-col items-start gap-y-2">
            <div className="relative flex h-28 w-full overflow-hidden rounded-md shadow-md select-none" ref={boxRef}>
                  ...
                  {themeOptions.map((themeOption) => (
                     <button
                        ...
                        className={clsx(
                           ...
                           themeType === themeOption.type ? "scale-125 shadow-md" : "opacity-50 hover:scale-110 hover:opacity-90",
                        )}
                        style={{ backgroundColor: themeOption.theme["primary-500"] }}
                        onClick={() => props.onChange?.({ theme: themeOption.type })}
                        onMouseEnter={() => setPreviewThemeType(themeOption.type)}
