...
export default function ImageSelector(props: {
   ...
   return (
      <div className={clsx("bg-surface-alt flex w-max shrink-0 flex-col rounded-lg p-3", props.className)}>
         {props.children}
         ...
         <div className={clsx("mt-3 flex w-full items-center justify-center gap-x-0.5", props.buttonsClassName)}>
            <Tooltip>
               <Tooltip.Trigger
                  ...
                  type="button"
                  className={clsx("bg-surface hover:bg-primary-700 flex w-full justify-center rounded-l-md py-1.5", props.editButtonClassName)}
               >
            ...
            <Tooltip>
               <Tooltip.Trigger
                  ...
                  type="button"
                  className={clsx(
                     "group bg-negative-100/10 hover:bg-negative-400 flex w-full justify-center rounded-r-md py-1.5",
                     props.deleteButtonClassName,
                  )}
               >
                  <IconMingcuteDelete3Fill className="text-negative-100 size-5 group-hover:text-white" />
               </Tooltip.Trigger>
               <Tooltip.Content>
