...
function SlateRenderer(props: {
	...
	return (
		<div
			className={clsx(
				"wrap-anywhere relative whitespace-break-spaces px-2.5 py-1.5 font-normal text-white group-hover:shadow-sm transition-[background-color]",
				context.message.isPreview ? "bg-surface text-white/50" : props.isSelf ? "bg-primary-800" : "bg-surface",
