	...
	return (
		<div className="bottom-0 z-10 flex-col px-5 py-1.5" ref={thisRef}>
			...
			<form className="w-full">
				<div
					className={clsx(
						"flex h-full items-start rounded-3xl border-2 border-surface bg-surface-deep transition-[border-radius]",
				...
				>
					<Tooltip>
						<Tooltip.Trigger
							onClick={addFiles}
							type="button"
							className="m-2 mr-2 flex shrink-0 cursor-pointer items-center rounded-full bg-surface p-1.5 transition-all hover:bg-white/20 hover:shadow-xl"
						>
					...
					<div className="ml-2 flex h-8 gap-x-2 p-2">
						...
						<div className="h-8 w-8 rounded-full bg-surface" />
						<button className="h-8 w-8 rounded-full bg-primary-700 p-0.5" type="button" onClick={() => sendMessage(MessageFlags.NONE)}>
