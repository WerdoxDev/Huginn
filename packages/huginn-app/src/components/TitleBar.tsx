	...
	return createPortal(
		...
		>
			...
			<div className="no-drag-region ml-auto flex h-full">
				<button type="button" className="flex h-full w-10 cursor-pointer items-center justify-center hover:bg-secondary" onClick={minimize}>
					<IconMingcuteMinimizeFill className="h-4 w-4 text-white opacity-80" />
				</button>
				<button type="button" className="flex h-full w-10 cursor-pointer items-center justify-center hover:bg-secondary" onClick={maximize}>
				...
				<button type="button" className="flex h-full w-10 cursor-pointer items-center justify-center hover:bg-error" onClick={close}>
