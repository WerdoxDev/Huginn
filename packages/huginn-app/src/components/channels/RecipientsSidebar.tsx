...
export default function RecipientsSidebar(props: { channelId: Snowflake; recipientIds: Snowflake[]; ownerId: Snowflake; visible: boolean }) {
	...
	return (
		<Transition show={props.visible}>
			<div className="group relative my-2 mb-16 w-56 shrink-0 transition-all duration-200 data-closed:w-0 data-closed:scale-90 data-closed:opacity-0">
				<div className="absolute top-0 bottom-2 flex w-54 flex-col gap-y-2 overflow-hidden rounded-xl bg-secondary p-2 shadow-lg ring-2 ring-primary/70 transition-all duration-700 group-data-closed:ring-0">
