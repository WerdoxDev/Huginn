   ...
   return (
      <MessageContext.Provider value={{ ...props }}>
         {props.message.isUnread && !props.message.hasNewDate && (
            <li
               className={clsx(
                  "bg-negative-300 pointer-events-none relative mr-10 ml-2 flex h-px shrink-0 items-center justify-center",
         ...
         {props.message.hasNewDate && (
            <li
               className={clsx(
                  "relative mx-2 flex h-0 shrink-0 items-center justify-center border-t border-b text-center text-xs font-medium",
            ...
            >
               ...
               {props.message.isUnread && (
                  <div className="bg-negative-300 absolute -right-2 flex w-10 items-center justify-center rounded-l-md py-1 text-xs font-bold text-white uppercase">
                     new
                  </div>
               )}
            </li>
