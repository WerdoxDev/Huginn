import { Button, Html, Head, Body, Tailwind, Img, Font, Text, Container } from "@react-email/components";
            ...
            <Body>
               <div className="mx-auto max-w-lg">
                  <div className="my-10 rounded-3xl bg-[#1f1f1f] px-8 py-8">
                     ...
                     <Text className="mb-8 mt-0 text-center text-lg text-white/80">Enter this code in huginn to verify this email address</Text>
