...
export default function App() {
  ...
  return (
    <>
      <Analytics />
      <div className="fixed top-0 z-30 flex w-full items-center border-b border-text bg-black/30 px-5 py-4 backdrop-blur-md md:justify-center md:pl-20 md:pr-10">
        <Link
          to="/"
          className={`flex items-center transition-opacity duration-[250ms] ${isMenuOpen ? "opacity-0" : ""}`}
        >
        ...
        <div className="ml-auto hidden gap-x-10 md:flex">
          ...
          <div className="w-0.5 bg-text/30" />
      ...
      <div
        className={`fixed inset-0 z-40 bg-black/25 transition-opacity duration-[250ms] ${
      ...
      <div
        className={`fixed right-0 z-50 h-full w-4/5 bg-tertiary shadow-xl transition-transform duration-[250ms] ${
      ...
      >
        ...
        <div className="ml-10 mt-10 flex flex-col gap-y-7">
      ...
      <div className="flex h-full flex-col">
        ...
        <ThemeChanger className="sticky bottom-5 mb-5 ml-auto mr-5" />

        <div className="relative flex shrink-0 flex-col border-t border-tertiary bg-secondary bg-gradient-to-t px-5 py-3 md:flex-row md:px-12">
          ...
          <div className="mt-4 flex items-center space-x-7 md:ml-auto md:mr-7 md:mt-0 md:space-x-5">
