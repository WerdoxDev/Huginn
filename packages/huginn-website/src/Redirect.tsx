      ...
      <div className="flex w-full items-center justify-center">
        <div className="flex h-max flex-col items-center justify-center gap-y-5">
          <img
            ...
            className="size-32 animate-pulse text-text drop-shadow-[0px_0px_50px_#EBEBD3]"
          />
          <div className="text-center">
            <div className="flex items-center justify-center gap-x-2 text-2xl font-bold text-text">
              <span>{title}</span>
              {showSuccess ? (
                <svg
            ...
            {showSuccess ? (
              <div className="mt-2 max-w-lg text-lg text-text/80">
                <span>
                  You can return to the application and safely close this window. If you are not
            ...
            {showError ? (
              <div className="mt-2 max-w-lg text-lg text-text/80">
                <span>
                  The authentication process was cancelled! You can safely close this window and
                  start again in the application
                </span>
              </div>
            ) : null}
          </div>
