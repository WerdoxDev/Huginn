...
export default function Download() {
   const [latestRelease, setLatestRelease] = useState<APIGetLatestReleaseResult | undefined>(undefined);
      ...
      <>
         ...
         <div className="mb-auto flex flex-col items-center gap-y-5 px-4 pb-32">
            ...
            {!loadingOlder && !loading ? (
               <button className="text-accent text-lg hover:underline" onClick={loadOrHideOlder} type="button">
            ...
            {showingOlder && allReleases.length === 0 ? <div className="text-lg">No more releases...</div> : null}
         </div>
      </>
   );
}
