      ...
      <div class="flex flex-col md:flex-row md:space-x-7">
         <div class="w-full px-4 md:w-96 md:px-0">
            <div class="flex flex-col items-center justify-center md:flex-row md:justify-start">
               ...
               <p class="text-5xl font-extrabold text-[#EBEBD3] md:ml-4">Huginn</p>
            </div>
            ...
            <div class="flex w-full flex-row space-x-2 pt-10">
               ...
               <a
                  ...
                  class="hidden size-12 flex-shrink-0 items-center justify-center rounded-md border-2 border-[#464646] bg-[#262626] transition-all hover:bg-[#1f1f1f] md:flex"
               >
         ...
         <div class="mx-4 mt-6 rounded-2xl bg-[#262626] p-1 md:mx-0 md:mt-0">
