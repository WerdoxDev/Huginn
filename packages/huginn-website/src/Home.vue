         ...
         <div class="w-full px-4 md:w-96 md:px-0">
            <div class="flex flex-col items-center justify-center md:flex-row md:justify-start">
               <img
                  ...
                  class="size-24 object-contain transition-all hover:-rotate-12 active:rotate-6 md:size-20"
               />
               <p class="mt-4 text-5xl font-extrabold text-text md:ml-4 md:mt-0">Huginn</p>
            </div>

            <div
               class="mx-auto mt-8 flex w-fit flex-row items-center gap-x-2 rounded-full border border-primary bg-tertiary/50 px-4 py-2 pr-6 shadow-md transition-all hover:shadow-lg"
            >
               <Icon icon="mingcute:group-3-fill" class="size-10 text-accent" />
               <p class="text-center text-xl font-bold md:text-left">
                  <span class="font-bold text-accent">{{ onlineCount }}</span>
                  warriors online!
               </p>
            </div>

            <p class="mx-2 mt-8 text-center text-2xl md:mx-0 md:text-left">A fast, customizable chat app with a touch of Norse mythology.</p>

            <div class="mt-12 flex w-full flex-row space-x-2">
               <RouterLink
                  to="/download"
