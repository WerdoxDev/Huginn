...
export class RelationshipAPI {
   ...
   public async get(userId: Snowflake): Promise<APIGetUserRelationshipByIdResult> {
      return this.rest.get(Routes.userRelationship(userId), {
         auth: true,
      }) as Promise<APIGetUserRelationshipByIdResult>;
   }

   public async getAll(): Promise<APIGetUserRelationshipsResult> {
      return this.rest.get(Routes.userRelationships(), {
         auth: true,
      }) as Promise<APIGetUserRelationshipsResult>;
   }
