...
export type HuginnButtonColor = "primary" | "surface-deep" | "surface-alt" | "surface" | "positive" | "negative" | "caution" | "ghost";

export type HuginnButtonProps = Omit<ComponentPropsWithRef<"button">, "color"> & {
   color?: HuginnButtonColor;
};

const colors: Record<HuginnButtonColor | "none", string> = {
   none: "",
...
export default function HuginnButton({ color, className, ...props }: HuginnButtonProps) {
   return (
      <button
         {...props}
         className={clsx(
